...
<div class="wrapper">
    ...
    <div class="main main-raised">
        <div class="section section-basic">
            <div class="container">
                <div class="row">
                    <h2 class="title"> Affine Cipher Decoder</h2>
                        ...
                        <div class="card card-signup">
                            <form class="form" method="" action="">
                                    ...
                                    <form method="get" action="javascript:void(0);">
                                        <div class="col-sm-12">
                                            <div class="form-group label-floating">
                                                ...
                                                <input id="textinput" type="text" value="MN" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group label-floating">
                                                ...
                                                <input id="firstKey" type="number"  value="2" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group label-floating">
                                                <label class="control-label">THE SHIFT:</label>
                                                <input id="secondkey" type="number"  value="5" class="form-control">
                                            </div>
                                        </div>
                                ...
                                <div class="footer text-center">
                                    <input type="button" disabled value="Plesae wait" class="btn btn-primary"
                                           id="affineD"/>
                                </div>
                            </form>
                        </div>
